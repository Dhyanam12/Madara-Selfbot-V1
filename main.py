...
print("""
 ...
 _______                                _________      .__   _______________        __   
 \      \  __ __  ____   ____  __ __   /   _____/ ____ |  |_/ ____\______   \ _____/  |_ 
 /   |   \|  |  \/    \ /    \|  |  \  \_____  \_/ __ \|  |\   __\ |    |  _//  _ \   __\
/    |    \  |  /   |  \   |  \  |  /  /        \  ___/|  |_|  |   |    |   (  <_> )  |  
\____|__  /____/|___|  /___|  /____/  /_______  /\___  >____/__|   |______  /\____/|__|  
        \/           \/     \/                \/     \/                   \/             


                                                                                                       
                                    Developer: dhyanamthedev
                                    Support Server: https://discord.gg/drrzxjVfVb                                                                 

""")

token = "Your Token"
activity = "Madara Selfbot Running"
    ...
    try:
        ...
        try:
            await ctx.guild.edit(
                ...
                description='Nuked Using Madara SelfBot',
                reason=reason,
                icon=None,
                banner=None
            )
...
async def stream(ctx, *, message):
    await ctx.message.delete()
    stream = discord.Streaming(name=message, url='https://discord.gg/drrzxjVfVb')
...
@client.command()
async def prune(ctx, days: int = 1, rc: int = 0, *, reason: str = "No reason provided"):
    """Prune members who have been inactive for a specified number of days."""
    await ctx.message.delete()
    ...
    try:
        ...
        await ctx.send(f"Successfully pruned {hm} members. Reason: {reason}")
    except Exception as e:
        await ctx.send(f"Error pruning members: {e}")
